...
object SitesConfig {
    ...
    fun all(): List<Site> = listOf(
        ...
        // 红石与投影
        Site("红石计划", "https://www.redstoneplan.com", "红石机械与生电存档", "红石与投影"),
        Site("Litematica 投影库", "https://www.litematica.net", "投影（schematic）下载", "红石与投影"),
        ...
        Site("Fabric 文档", "https://fabricmc.net/wiki", "Fabric 加载器与 API 文档", "百科与教程"),
